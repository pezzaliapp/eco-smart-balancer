...
Un'equilibratrice ruote come una **Cormach MEC 810**, ma:

- **±0,8 g** di precisione (vs ±1 g standard) grazie a 2 accelerometri MEMS digitali ADXL355
- **3–5 Wh** di consumo per lancio (60–70% in meno del riferimento)
...
- **Costo materiali ~1.750 €** (vs ~3.500 € listino MEC 810)
...
```bash
git clone https://github.com/<user>/eco-smart-balancer
cd eco-smart-balancer/simulation/python
pip install -r requirements.txt
python balance_sim.py --sweep
# apri reports/<timestamp>.html nel browser
```
...
⏱️ **Tempo stimato self-build:** 80–120 ore di officina, ~1.750 € di componenti.

---

## 📊 Performance vs riferimento (MEC 810)

| Metrica | Eco-Smart | MEC 810 |
|---|---|---|
| Precisione | ±0,8 g | ±1 g |
| Consumo per lancio | 3–5 Wh | 10–15 Wh |
| Tempo lancio | 5–7 s | 5–7 s |
| Compatibilità coni Ø40mm | ✅ | ✅ |
| Funzionamento solare puro | ✅ | ❌ |
| Recupero in frenata | ✅ | ❌ |
| Costo materiali | ~1.750 € | ~3.500 € listino |
| Open hardware | ✅ | ❌ |

> Il confronto con MEC 810 è puramente di posizionamento. MEC 810 è un prodotto certificato e supportato; Eco-Smart è (per ora) un progetto comunità.

---

## 🛣️ Roadmap

- [x] **F0** — Studio fattibilità + documento progetto
...
- **Firmware e software**: [MIT](LICENSE)
- **Documentazione**: [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)
...
**Posso venderlo?**
Sì, la licenza CERN-OHL-S lo permette, ma devi rilasciare le tue modifiche con la stessa licenza e marcare CE a tuo nome (con tutti gli oneri del caso).

**Funziona davvero solo a luce solare?**
In Italia centro-nord, in officina con tetto a 30° esposto a sud, un pannello da 150 W produce in media 0,5–0,7 kWh/giorno. Con 30–50 lanci/giorno (consumo 150–250 Wh) il bilancio è positivo. La batteria copre i picchi e le ore notturne.

**Perché non albero verticale come chiede il committente originale?**
Analizzato e scartato per ruote auto: footprint troppo grande, carter complesso, sensori asimmetrici a basso RPM. Vedi [`docs/00-architecture.md#vertical-vs-horizontal`](docs/00-architecture.md). Per camion la storia cambia (vedi MEC 200 RLC come riferimento commerciale).

**Compatibilità con coni e flange Cormach?**
Sì, l'attacco mandrino Ø40 mm è compatibile con tutto il parco accessori standard (coni, flange, pinze 4/5 fori).
...
- Email: [your-email]
- Discord/Forum: [da definire]

---

*Built with ☀️ in Italy — May 2026*
